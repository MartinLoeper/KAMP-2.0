...
public class KampRuleLanguageInjectorProviderForCompilation extends KampRuleLanguageInjectorProvider {
	...
	protected KampRuleLanguageRuntimeModule createRuntimeModule() {
		return new KampRuleLanguageRuntimeModule() {
			...
			public void configure(Binder binder) {				
				binder.bind(RegisteringFileSystemAccess.class).toProvider(KampRuleLanguageFileSystemAccessProvider.class);

...
public class RunOcl implements IActionDelegate {
	...
	public void run(IAction action) {
		...
		String folderPath = "/Example/modified/example.system";
		ResourceSet resourceSet = new ResourceSetImpl();
		Resource resource = AbstractArchitectureVersionPersistency.loadEmfModelFromResourceWithoutPackageRegistering(folderPath, null, resourceSet);
